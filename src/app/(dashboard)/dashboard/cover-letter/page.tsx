...
export default function CoverLetterPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // NOTE: Replace this mock delay with your actual /api/ai/generate fetch call
      // once your Anthropic API credits are replenished.
      await new Promise(resolve => setTimeout(resolve, 2000))
      
      setCoverLetter("Dear Hiring Manager,\n\nBased on the job description, I am thrilled to apply for this position. My experience building full-stack applications with Next.js, React, and Node.js aligns perfectly with your requirements.\n\nThank you for your time and consideration.\n\nBest regards,\n[Your Name]")
    } catch (error) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 space-y-4 flex flex-col">
          ...
          <div className="w-full flex-1 bg-gray-950 border border-gray-700 rounded-lg p-4 text-gray-300 text-sm whitespace-pre-wrap overflow-y-auto min-h-[16rem]">
            {coverLetter || <span className="text-gray-600 italic">Your generated cover letter will appear here...</span>}
          </div>
        </div>
      </div>
    </div>
